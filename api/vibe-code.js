...
const SYSTEM_PROMPT = [
  ...
  "Project 2 adds two no-force sensors for users with very limited motion: (1) a TTP223B capacitive touch module (3 pins: GND, VCC 2.5-5.5V, SIG) - SIG goes HIGH on a light touch, no pressing force needed; read it like a digital button with digitalRead, no library required. (2) a VL53L0X time-of-flight infrared distance sensor on the I2C bus (VIN 3.3-5V, GND, SDA -> pin 2 on a Leonardo, SCL -> pin 3); it needs the Adafruit_VL53L0X library, Wire.begin(), and you read a distance in millimeters, then trigger when an object is within a chosen range. The VL53L0X breakout ships with loose header pins that must be soldered on before use.",
  "",
  ...
  "- VL53L0X distance: VIN to 5V, GND to GND, SDA to pin 2, SCL to pin 3.",
